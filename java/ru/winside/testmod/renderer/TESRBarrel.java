...
public class TESRBarrel extends TileEntitySpecialRenderer {
	...
	IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(Main.MODID, "models/Barrel.obj"));
	ResourceLocation texture = new ResourceLocation(Main.MODID, "textures/blocks/wood.jpg");
